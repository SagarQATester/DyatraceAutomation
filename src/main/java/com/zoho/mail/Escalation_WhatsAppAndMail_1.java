...
public class Escalation_WhatsAppAndMail_1{
    ...
    private static final String[] CRITICAL_L2_EMAILS = {"sagar.k@believe-it.in"};
    private static final String[] NON_CRITICAL_L1_EMAILS = {"sagar.k@believe-it.in"};
    private static final String[] NON_CRITICAL_L2_EMAILS = {"sagar.k@believe-it.in"};
    ...
    static {
        ...
        escalationTimeFrames.put("NonCritical_L1", 0); // 1 minute for L1
        ...
        escalationMails.put("Critical_L1", CRITICAL_L1_EMAILS);
        escalationMails.put("Critical_L2", CRITICAL_L2_EMAILS);
        escalationMails.put("NonCritical_L1", NON_CRITICAL_L1_EMAILS);
        escalationMails.put("NonCritical_L2", NON_CRITICAL_L2_EMAILS);
    }
