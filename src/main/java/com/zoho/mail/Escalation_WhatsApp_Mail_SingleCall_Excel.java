...
public class Escalation_WhatsApp_Mail_SingleCall_Excel{
        ...
        try {
            ...
            for (Message message : messages) {
                ...
                if (fromAddresses != null && fromAddresses.length > 0 &&
                    ...
                    String callformattedMessage ="*Problem State:* " + problemState + "\n" +
                            "*Problem ID:* " + problemID + "\n" +
                            "*Problem Severity:* " + problemSeverity + "\n" +
                            "*Impacted Entities:* " + impactedEntities + "\n" +                            
                            "*Host:* " + host + "\n" +
                    ...
                    if ("OPEN".equalsIgnoreCase(problemState)) {
                       ...
                       // sendVoiceCall("+919011734501", callformattedMessage);
 ...
 // Helper method to check if the problem is still open
    ...
    public static void sendVoiceCall(String to, String formattedMessage) {
        try {
